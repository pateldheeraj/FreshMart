...
export const ConfirmDelete = ({close,cancel,confirm}) => {
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 z-50 bg-neutral-800/60 p-4 flex items-center justify-center">
        <div className="bg-white w-full max-w-md p-4 rounded">
            ...
            <p className="py-4">Are you sure permanent delete ?</p>
